...
H2("2.3. Асинхронная схема получения отчётов")
...
H2("2.7. Особый случай — кумулятивная метрика «REPLACE_CUMULATIVE_METRIC»")
...
H2("3.1. REPLACE_FUNCTION_1_SIGNATURE")
...
H2("3.2. REPLACE_FUNCTION_2_SIGNATURE")
...
# ── 4. Алгоритм ───────────────────────────────────────────────────────────────
H1("4. Алгоритм сбора статистики (общий шаблон)")
...
H2("6.2. REPLACE_FUNCTION_2_NAME — дневная статистика")
TABLE(
