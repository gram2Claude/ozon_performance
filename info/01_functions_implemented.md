...
- **Тип:** справочник
- **Файл:** `ozon_performance.py` → `get_campaign_dict()`
- **Spec:** `specs/01_spec_get_campaign_dict.md`
- **Plan:** `plans/01_plan_get_campaign_dict.md`
- **Smoke-test:** `smoke_tests/test_get_campaign_dict.py`
...
- **Дата реализации:** 2026-05-11
- **Тип:** статистика
- **Файл:** `ozon_performance.py` → `get_campaigns_daily_stat()`
- **Spec:** `specs/02_spec_get_campaigns_daily_stat.md`
- **Plan:** `plans/02_plan_get_campaigns_daily_stat.md`
- **Smoke-test:** `smoke_tests/test_get_campaigns_daily_stat.py`
