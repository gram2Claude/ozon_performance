...
TABLE(
    ["campaign_id", "costs_without_nds", "ak", "costs_nds_ak", "costs_without_nds_ak"],
    [
        ["24251481", "36310.7", "0.5", "66447.0",  "54466.1"],
        ["24296538", "75821.0", "0.5", "138753.9", "113731.5"],
        ["24251481", "36256.8", "0.5", "66348.5",  "54385.2"],
    ],
    [26, 32, 12, 28, 34],
)
P("Константные поля для тех же строк:")
TABLE(
    ["campaign_id", "account_id", "source_type_id", "id_key_camp"],
    [
        ["24251481", "1", "9", "1_24251481"],
        ["24296538", "1", "9", "1_24296538"],
        ["24251481", "1", "9", "1_24251481"],
    ],
    [26, 22, 26, 58],
)
...
TABLE(
    ...
    [
        ["602634", "35673.0", "0.5", "65281.5", "53509.5"],
        ["602637", "40148.9", "0.5", "73472.4", "60223.4"],
        ["602761", "21174.6", "0.5", "38749.5", "31761.9"],
    ],
    [22, 30, 12, 28, 30],
)
P("Константные и вычисляемые ключи для тех же строк:")
TABLE(
    ["campaign_id", "ad_id", "account_id", "source_type_id", "id_key_camp", "id_key_ad"],
    [
        ["24296538", "602634", "1", "9", "1_24296538", "1_24296538_602634"],
        ["24296538", "602637", "1", "9", "1_24296538", "1_24296538_602637"],
        ["24251481", "602761", "1", "9", "1_24251481", "1_24251481_602761"],
    ],
    [24, 20, 18, 22, 30, 38],
)
P("Значения константных полей приведены как пример — при интеграции заменить на актуальные.")
...
TABLE(
    ["campaign_id", "ad_id", "account_id", "source_type_id", "id_key_camp", "id_key_ad"],
    [
        ["24251481", "598953", "1", "9", "1_24251481", "1_24251481_598953"],
        ["24251481", "598953", "1", "9", "1_24251481", "1_24251481_598953"],
        ["24251481", "598956", "1", "9", "1_24251481", "1_24251481_598956"],
    ],
    [24, 20, 18, 22, 30, 38],
)
P("Значения константных полей приведены как пример — при интеграции заменить на актуальные.")
...
P("Видео-метрики для той же строки:")
TABLE(
    ["ad_id", "q25", "q50", "q75", "q100", "views_with_sound", "costs_nds"],
    [
        ["401234", "9800", "7200", "5100", "3200", "6800", "18504.0"],
    ],
    [20, 20, 20, 20, 20, 30, 28],
)
P("Вычисляемые поля для той же строки:")
TABLE(
    ["ad_id", "costs_without_nds", "ak", "costs_nds_ak", "costs_without_nds_ak"],
    [
        ["401234", "15167.2", "0.5", "27756.0", "22750.8"],
    ],
    [22, 32, 12, 28, 34],
)
P("Константные и вычисляемые ключи для той же строки:")
TABLE(
    ["campaign_id", "ad_id", "account_id", "source_type_id", "id_key_camp", "id_key_ad"],
    [
        ["16568770", "401234", "1", "9", "1_16568770", "1_16568770_401234"],
    ],
    [24, 20, 18, 22, 30, 38],
)
