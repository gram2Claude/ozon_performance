...
```python
ADS_STAT_COLUMNS = ["date", "campaign_id", "ad_id", "ad_name", "impressions", "clicks", "costs_nds"]
```
...
- Для каждой строки данных:
  ...
  - Вернуть dict с полями `date`, `campaign_id`, `ad_id`, `ad_name`, `impressions`, `clicks`, `costs_nds`
